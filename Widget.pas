unit Widget;
{
This Widget library unit:
1.  Provides built-in widgets: Button, Label, Image.
2.	Provides an ability to instantiate widgets by their types of names by dialog window or config file 'widgets.ini'.
3.	Provides an ability to extend it with new user-defined widgets in code (i.e., not part of the library)
4.	Provides grouping (ability to create groups that can contain widgets and groups) - e.g., dialog window
5.	Provides the ability to attach/detach widgets to/from a group.
...
type
  ...
  public
    ...
    class var function CreateTypesList(listBox: TListBox):String;
...
function TWidget.CreateTypesList(listBox: TListBox):String;
var
...
begin
  ...
  try
    ...
    begin
        ...
        startsWith:=(LType.QualifiedName<>'') and
            (LType.QualifiedName<>'Widget.TWidget') and (i=1);
